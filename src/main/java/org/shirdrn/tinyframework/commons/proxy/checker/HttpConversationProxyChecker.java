 ...
 * @author Yanjun
 */
public class HttpConversationProxyChecker extends ProxyChecker {

	private static final Logger LOG = Logger.getLogger(HttpConversationProxyChecker.class);
	...
	public HttpConversationProxyChecker(ProxyFactory proxyFactory) {
		super(proxyFactory);
