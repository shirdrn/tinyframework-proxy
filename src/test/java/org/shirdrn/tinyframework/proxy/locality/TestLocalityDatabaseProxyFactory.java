...
public class TestLocalityDatabaseProxyFactory {


	private static final Log LOG = LogFactory.getLog(TestLocalityDatabaseProxyFactory.class);
	LocalityProxyFactory factory;
	
	@Before
	public void initialize() {
		factory = new LocalityDatabaseProxyFactory();
